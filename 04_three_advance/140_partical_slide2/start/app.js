...
async function init() {
  ...
  ***************************************************************/
  function setupGeometry() {
    ...
    ***************************************************************/
    ...
    // aからbの乱数を返す
    // 最大力から最小値を引いて0から1までを掛け合わす。そこに最小値を足す
    function random(a, b){
      // a + (b -  a) * Math.random();
    ...
    plane.setAttribute("aIntensity", new THREE.Float32BufferAttribute(intensityVertices, 1));
  ...
  ***************************************************************/
  ...
  // lil gui
  const gui = new GUI();
  gui.add(material.uniforms.uProgress, "value", 0, 1, 0.001).name("progress").listen();
